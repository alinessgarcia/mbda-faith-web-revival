    ...
    >
      ...
      <div className="relative z-10 text-center p-4 max-w-5xl mx-auto">
        <h1 className="mb-0 animate-fade-in">
          <span className="text-5xl md:text-6xl lg:text-7xl font-bold text-white block drop-shadow-lg">
            Ministério Bíblico da
          </span>
          <span className="text-6xl md:text-8xl lg:text-9xl font-bold text-amber-400 block mt-0.5 relative inline-block drop-shadow-xl">
            Reconciliação
