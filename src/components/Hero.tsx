...
const Hero = () => {
  ...
  <span className="text-2xl md:text-5xl lg:text-6xl font-bold text-blue-600 block drop-shadow-lg mb-0">
    Ministério Bíblico da
  </span>
  <span className="text-6xl md:text-8xl lg:text-9xl font-bold text-white block mt-0.2 relative inline-block drop-shadow-xl tracking-tight">
    Reconciliação
    <span className="block h-1 bg-blue w-full mt-2 mx-auto rounded-full shadow-lg"></span>
  </span>
</h1>
<p className="text-xl md:text-2xl lg:text-3xl text-white/95 mb-8 max-w-4xl mx-auto mt-2 animate-fade-in leading-snug drop-shadow-md" style={{ animationDelay: "0.2s" }}>
