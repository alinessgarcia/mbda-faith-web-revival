    ...
    <footer className="bg-primary text-white">
      <div className="container mx-auto py-10 px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">MBdA Reconciliação</h3>
            <p className="mb-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#quem-somos" className="hover:text-secondary transition-colors">
                  Quem Somos
                </a>
              </li>
              <li>
              ...
              <li>
                <Link to="/seterec" className="hover:text-secondary transition-colors">
                  S.E.T.E.R.E.C
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>Domingo: 18:00</li>
              <li>Terça-feira: 19:30</li>
              <li>Quinta-feira: 19:30</li>
            </ul>
            <div className="mt-4">
              <a
        ...
        <div className="mt-10 pt-6 border-t border-white/20 text-center text-white/70">
          <p>
            &copy; {currentYear} MBdA Reconciliação - Todos os direitos reservados
          </p>
        </div>
      </div>
    </footer>
