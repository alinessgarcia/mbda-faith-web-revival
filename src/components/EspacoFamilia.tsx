...
const EspacoFamilia = () => {
  ...
  return (
    <section id="espaco-familia" className="section-padding relative overflow-hidden bg-[#0a3676]/95">
      ...
      <div className="container mx-auto relative z-10">
        <div className="mb-10 md:mb-12">
          ...
          <h2 className="mt-3 text-3xl md:text-4xl font-bold text-white">Espaço Família</h2>
